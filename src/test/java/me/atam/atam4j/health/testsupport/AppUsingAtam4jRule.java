...
public class AppUsingAtam4jRule  implements TestRule {

    @ClassRule
    public static final DropwizardAppRule<Configuration> dropwizardAppRule = new DropwizardAppRule<>(AppUsingAtam4j.class, null);
